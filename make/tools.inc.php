...
/*
  ...
  IN $list - array, � ������� $list[$name] = $value.
  IN $type - string, ���� "c" ��� C, "php" ��� PHP.
...
/*
  ...
  IN $crypt   - int, ����������/������ ��������� �����, ���� ��������� ��� ���������.
                ...
                1 - �����.
                2 - ���������.
  IN $clearMz - bool, ��� winX, ���� true - �������� MSDOS ���������.
  IN $randBin - bool, ��� winX, ��������������� ���������� ��������� �����, ����� ������������� obj-������.
